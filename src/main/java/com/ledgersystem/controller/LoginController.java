...
public class LoginController {
    ...
    private void handleLogin(ActionEvent event) {
        ...
        switchScene(event, "/com/ledgersystem/fxml/dashboard.fxml");
    }

    @FXML
    private void handleGoToRegister(ActionEvent event) {
        switchScene(event, "/com/ledgersystem/fxml/register.fxml");
    }
    ...
    private void switchScene(ActionEvent event, String fxmlPath) {
        try {
            ...
            // stage.getWidth() includes the window frame/titlebar — scene does not
